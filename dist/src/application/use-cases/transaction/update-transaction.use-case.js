...
var UpdateTransactionUseCase_1;
...
let UpdateTransactionUseCase = UpdateTransactionUseCase_1 = class UpdateTransactionUseCase {
    constructor(transactionRepository) {
        this.transactionRepository = transactionRepository;
        this.logger = new common_1.Logger(UpdateTransactionUseCase_1.name);
    }
    async execute(id, updateTransactionDto) {
...
exports.UpdateTransactionUseCase = UpdateTransactionUseCase = UpdateTransactionUseCase_1 = __decorate([
