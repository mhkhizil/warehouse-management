...
var DeleteTransactionUseCase_1;
...
let DeleteTransactionUseCase = DeleteTransactionUseCase_1 = class DeleteTransactionUseCase {
    constructor(transactionRepository) {
        this.transactionRepository = transactionRepository;
        this.logger = new common_1.Logger(DeleteTransactionUseCase_1.name);
    }
    async execute(id) {
...
exports.DeleteTransactionUseCase = DeleteTransactionUseCase = DeleteTransactionUseCase_1 = __decorate([
