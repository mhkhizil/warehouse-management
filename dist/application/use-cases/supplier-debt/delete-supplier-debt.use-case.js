...
exports.DeleteSupplierDebtUseCase = void 0;
const common_1 = require("@nestjs/common");
const repository_tokens_1 = require("../../../domain/constants/repository.tokens");
let DeleteSupplierDebtUseCase = class DeleteSupplierDebtUseCase {
...
exports.DeleteSupplierDebtUseCase = DeleteSupplierDebtUseCase;
exports.DeleteSupplierDebtUseCase = DeleteSupplierDebtUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(repository_tokens_1.SUPPLIER_DEBT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], DeleteSupplierDebtUseCase);
//# sourceMappingURL=delete-supplier-debt.use-case.js.map