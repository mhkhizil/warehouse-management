...
exports.FindOverdueSupplierDebtsUseCase = void 0;
const common_1 = require("@nestjs/common");
const repository_tokens_1 = require("../../../domain/constants/repository.tokens");
let FindOverdueSupplierDebtsUseCase = class FindOverdueSupplierDebtsUseCase {
...
exports.FindOverdueSupplierDebtsUseCase = FindOverdueSupplierDebtsUseCase;
exports.FindOverdueSupplierDebtsUseCase = FindOverdueSupplierDebtsUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(repository_tokens_1.SUPPLIER_DEBT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], FindOverdueSupplierDebtsUseCase);
//# sourceMappingURL=find-overdue-supplier-debts.use-case.js.map