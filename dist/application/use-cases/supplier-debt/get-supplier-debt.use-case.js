...
exports.GetSupplierDebtUseCase = void 0;
const common_1 = require("@nestjs/common");
const repository_tokens_1 = require("../../../domain/constants/repository.tokens");
let GetSupplierDebtUseCase = class GetSupplierDebtUseCase {
    ...
    async findByTransactionId(transactionId) {
        const debt = await this.supplierDebtRepository.findByTransactionId(transactionId);
        if (!debt) {
            throw new common_1.NotFoundException(`Supplier debt with transaction ID ${transactionId} not found`);
        }
        return debt;
    }
...
exports.GetSupplierDebtUseCase = GetSupplierDebtUseCase;
exports.GetSupplierDebtUseCase = GetSupplierDebtUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(repository_tokens_1.SUPPLIER_DEBT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], GetSupplierDebtUseCase);
//# sourceMappingURL=get-supplier-debt.use-case.js.map