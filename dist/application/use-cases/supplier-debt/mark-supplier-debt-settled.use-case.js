...
exports.MarkSupplierDebtSettledUseCase = void 0;
const common_1 = require("@nestjs/common");
const repository_tokens_1 = require("../../../domain/constants/repository.tokens");
let MarkSupplierDebtSettledUseCase = class MarkSupplierDebtSettledUseCase {
...
exports.MarkSupplierDebtSettledUseCase = MarkSupplierDebtSettledUseCase;
exports.MarkSupplierDebtSettledUseCase = MarkSupplierDebtSettledUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(repository_tokens_1.SUPPLIER_DEBT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], MarkSupplierDebtSettledUseCase);
//# sourceMappingURL=mark-supplier-debt-settled.use-case.js.map