...
var MarkDebtSettledUseCase_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.MarkDebtSettledUseCase = void 0;
const common_1 = require("@nestjs/common");
const repository_tokens_1 = require("../../../domain/constants/repository.tokens");
let MarkDebtSettledUseCase = MarkDebtSettledUseCase_1 = class MarkDebtSettledUseCase {
    constructor(debtRepository) {
        this.debtRepository = debtRepository;
        this.logger = new common_1.Logger(MarkDebtSettledUseCase_1.name);
    }
    async execute(id) {
...
exports.MarkDebtSettledUseCase = MarkDebtSettledUseCase;
exports.MarkDebtSettledUseCase = MarkDebtSettledUseCase = MarkDebtSettledUseCase_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(repository_tokens_1.DEBT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], MarkDebtSettledUseCase);
//# sourceMappingURL=mark-debt-settled.use-case.js.map