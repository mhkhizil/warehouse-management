...
let GetTransactionUseCase = GetTransactionUseCase_1 = class GetTransactionUseCase {
    constructor(transactionRepository) {
        this.transactionRepository = transactionRepository;
        this.logger = new common_1.Logger(GetTransactionUseCase_1.name);
    }
    async execute(id) {
...
exports.GetTransactionUseCase = GetTransactionUseCase = GetTransactionUseCase_1 = __decorate([
